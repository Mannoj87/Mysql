-- MySQL dump 10.13  Distrib 5.7.19-17, for Linux (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-09-15 10:10:39',NULL),('diagnostics.include_raw','OFF','2017-09-15 10:10:39',NULL),('ps_thread_trx_info.max_length','65535','2017-09-15 10:10:39',NULL),('statement_performance_analyzer.limit','100','2017-09-15 10:10:39',NULL),('statement_performance_analyzer.view',NULL,'2017-09-15 10:10:39',NULL),('statement_truncate_len','64','2017-09-15 10:10:39',NULL);
...
--
-- Current Database: `things`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `things` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `things`;

--
-- Table structure for table `blahs`
--

DROP TABLE IF EXISTS `blahs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blahs` (
...
--
-- Dumping data for table `blahs`
--

LOCK TABLES `blahs` WRITE;
/*!40000 ALTER TABLE `blahs` DISABLE KEYS */;
INSERT INTO `blahs` VALUES (1,'{}','0000-00-00 00:00:00'),(30,'{\"foo\": 1}','0000-00-00 00:00:00'),(35,'{\"bar\": 4}','2017-07-10 18:36:08');
/*!40000 ALTER TABLE `blahs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-09-16  8:36:07
